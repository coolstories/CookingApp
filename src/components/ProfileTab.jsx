          ...
          <div className="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl">
            ...
            {selectedMenu.id === 'settings' && (
              <div className="space-y-3">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="text-sm font-medium text-gray-900">AI Uncertainty Questions</p>
                  <p className="text-xs text-gray-500 mt-1 mb-2">Ask for confirmation when AI is unsure about ingredients</p>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={settings.unsureIngredients}
                      onChange={(e) => setSettings({...settings, unsureIngredients: e.target.checked})}
